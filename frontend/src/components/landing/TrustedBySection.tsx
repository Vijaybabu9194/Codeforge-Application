...
export const TrustedBySection: React.FC = () => {
  ...
  const textStyle = dark 
    ...
    : 'text-slate-800 hover:text-slate-950 font-black';

  return (
    <section id="companies" className="pt-0 pb-4 -mt-2 w-full max-w-full px-6 md:px-12 relative z-10 select-none">
      <div className="flex flex-col text-left">
        {/* Trusted by label */}
        <p className={`text-[12px] mb-4 font-bold tracking-wider uppercase ${dark ? 'text-slate-500' : 'text-slate-500'}`}>
        ...
        <div className="flex flex-wrap items-center gap-x-10 gap-y-5">
          ...
          <div className={`flex items-center gap-2 transition-colors duration-200 cursor-pointer ${textStyle}`}>
            ...
            <span className="font-extrabold text-[18px] tracking-tight">Google</span>
          </div>
          ...
          <div className={`flex items-center gap-1.5 transition-colors duration-200 cursor-pointer ${textStyle}`}>
            ...
            <span className="font-extrabold text-[18px] tracking-tight italic">amazon</span>
          </div>
          ...
          <div className={`flex items-center gap-2 transition-colors duration-200 cursor-pointer ${textStyle}`}>
            ...
            <span className="font-extrabold text-[18px] tracking-tight">Microsoft</span>
          </div>
          ...
          <div className={`flex items-center gap-2 transition-colors duration-200 cursor-pointer ${textStyle}`}>
            ...
            <span className="font-extrabold text-[18px] tracking-tight">Adobe</span>
          </div>
          ...
          <div className={`flex items-center gap-2 transition-colors duration-200 cursor-pointer ${textStyle}`}>
            ...
            <span className="font-extrabold text-[18px] tracking-tight">Uber</span>
          </div>
          ...
          <div className={`flex items-center gap-2 transition-colors duration-200 cursor-pointer ${textStyle}`}>
            ...
            <span className="font-extrabold text-[18px] tracking-tight">ATLASSIAN</span>
          </div>
        </div>
      </div>
    </section>
